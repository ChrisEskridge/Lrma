...
​	<div class="slider">
	...
	?>              
                 ...
                 <?php endwhile; endif; wp_reset_query(); ?>   
                    ...
                    <a href="<?php the_field('newsletter_file'); ?>">
                        ...
                        <div class="newsletter-title">
                    		Download the <br>Latest Newsletter
                    	</div>
                        </a>
                    </div>
	...
	<div class="exhibition-collection">
		...
		<div class="restricter2">
			...
			<div class="exhibition">
					...
					<div class="ex-wrap">
						...
						<a href="<?php the_permalink(); ?>">
							...
							<div class="ex-box">
								...
								<div class="ex-bottom">
									<div class="ex-title"><?php the_field('title'); ?></div>
									<div class="ex-tag"><?php the_field('tagline'); ?></div>
								</div>
							</div>
						</a> 
						<?php endwhile; endif; wp_reset_query(); ?>
				...
				</div><?php // end .ec-content ?>
			
			</div><?php // end .exhibition ?>
                  ...
                  <?php if( $collection_query->have_posts() ) : while( $collection_query->have_posts() ) : $collection_query->the_post(); ?>              
						...
						<a href="<?php the_permalink(); ?>">
							<div class="col-box">
								...
								<div class="col-text"><?php the_title(); ?></div>
							</div>
						</a>
						<?php endwhile; endif; wp_reset_query(); ?>
			...
			</div><?php // end .collection ?>
		
		</div><?php // end .restricter2 ?>
	
	</div><?php // end .exhibition-collection ?>
