<?php
/**
Template Name: Exhibition-Upcoming
**/
	...
	<div id="content" class="site-content">
        ...
        <div class="classes-main">
        	<div class="restricter2">
                ...
                <?php $upcoming_args = new WP_Query(array( 'post_type'		=> 'exhibition',
														'posts_per_page'	=> -1,
														...
														'meta_type'		=> 'numeric',
														'meta_value'		=> array($date_2, $date_3))); ?>
                                                            
                                                            
                     
            <?php if( $upcoming_args->have_posts() ) : 
	while( $upcoming_args->have_posts() ) : 
	$upcoming_args->the_post(); ?>              
                ...
                <!--<?php $upcoming_args = new WP_Query(array( 'post_type' => 'exhibition', 'posts_per_page' => -1, 'orderby' => 'meta_value_num', 'order' => 'ASC', 'meta_key' => 'date', 'meta_compare' => 'BETWEEN', 'meta_type' => 'numeric', 'meta_value'=> array($date_2, $date_3))); ?>
